...
const paginatedReportUrl = 'https://powerbi-payground-be-staging-1.azurewebsites.net/Reports/SampleRdlReport';
const layoutShowcaseReportUrl = 'https://powerbi-payground-be-staging-1.azurewebsites.net/Reports/LayoutDemoReport';
const insightToActionShowcaseReportUrl = 'https://powerbi-payground-be-staging-1.azurewebsites.net/Reports/InsightToActionReport';
const themesShowcaseReportUrl = 'https://powerbi-payground-be-staging-1.azurewebsites.net/Reports/ThemesReport';
const quickVisualCreatorShowcaseReportUrl = 'https://powerbi-payground-be-staging-1.azurewebsites.net/Reports/EmptyReport';
