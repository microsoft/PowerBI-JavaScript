const reportUrl = 'https://powerbi-payground-be-staging-1.azurewebsites.net/api/Reports/SampleReport';
const datasetUrl = 'https://powerbi-payground-be-staging-1.azurewebsites.net/api/Reports/SampleCreate';
const dashboardUrl = 'https://powerbi-payground-be-staging-1.azurewebsites.net/api/Dashboards/SampleDashboard';
const tileUrl = 'https://powerbi-payground-be-staging-1.azurewebsites.net/api/Tiles/SampleTile';
const qnaUrl = 'https://powerbi-payground-be-staging-1.azurewebsites.net/api/Datasets/SampleQna';
const paginatedReportUrl = 'https://powerbi-payground-be-staging-1.azurewebsites.net/api/Reports/SampleRdlReport';
const layoutShowcaseReportUrl = 'https://powerbi-payground-be-staging-1.azurewebsites.net/api/Reports/LayoutDemoReport';
const insightToActionShowcaseReportUrl = 'https://powerbi-payground-be-staging-1.azurewebsites.net/api/Reports/InsightToActionReport';
const themesShowcaseReportUrl = 'https://powerbi-payground-be-staging-1.azurewebsites.net/api/Reports/ThemesReport';
const quickVisualCreatorShowcaseReportUrl = 'https://powerbi-payground-be-staging-1.azurewebsites.net/api/Reports/EmptyReport';
